    ...
    return (
        <div className="UpgradeContainer">
            <div id='BurgerFlippers'>
                ...
                <button onClick={() => handleClick('burger-flipper', BurgerFlippersCountInternal, BurgerFlippersCostInternal)}>Buy</button>
            ...
            <div id='Restaurants'>
                <h1>Restaurants</h1>
                <button onClick={() => handleClick("Restaurants", RestaurantsCountInternal, RestaurantsCostInternal)}>Buy</button>
                <p className='CountText'>count = {RestaurantsCountInternal}</p>
                <p className='CostText'>cost = {RestaurantsCostInternal} <img src="src/components/freshBurger.png" alt="" /> </p>
            </div>

            <div id='Burger Company'>
                <h1>Burger Company</h1>
                <button onClick={() => handleClick("Burger-Company", RestaurantsCountInternal, RestaurantsCostInternal)}>Buy</button>
                <p className='CountText'>count = {RestaurantsCountInternal}</p>
                <p className='CostText'>cost = {RestaurantsCostInternal} <img src="src/components/freshBurger.png" alt="" /> </p>
            </div>
        </div>
